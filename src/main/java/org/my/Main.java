...
public class Main {
    ...
    public static void filterByCityHours(List<Phone> phones) {
        System.out.println("Enter the city hour: ");
        int hours = Integer.parseInt(Phone.scanner.nextLine());
        System.out.println("Information about subscribers whose city сonversation time is longer than " + hours);
        phones.stream()
    ...
    public static void filterByDistanceHours(List<Phone> phones) {
        System.out.println("Information about subscribers who used distance communication");
        phones.stream()
    ...
    public static void filterByNumber(List<Phone> phones) {
        ...
        int finalNum2 = num2;
        int finalNum1 = num1;
        System.out.println("Information about subscribers whose number is in the range from " + finalNum1 + " to " + finalNum2);
        phones.stream()
